...
ids=[int(a) for a in sys.argv[1:]] or range(1,8)
S=r'C:\Users\victo\AppData\Local\Temp\claude\c--Users-victo-PANGO-D-A-M-tfg\f6b3bcf5-04d3-4e8e-8d0c-088be1d129b0\scratchpad'
for i in ids:
