...
Mismo flujo, pero delegado a Claude Code con el [agente DirectorIA-Cloud](directoria-cloud.md) y el **MCP de Higgsfield conectado**, usando el modelo rápido (Claude 4.8 fast). El agente ejecuta directamente en lugar de solo entregar prompts.
