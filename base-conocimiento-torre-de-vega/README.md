...
| **2026-09-17** | Reel 09 «Volvemos a abrir»: carpeta nueva [`09-reel-volvemos-a-abrir-2026-09-17/`](09-reel-volvemos-a-abrir-2026-09-17/) (registro completo, aprendizajes, **efecto en costes**, composición Remotion y scripts), guion `reel_09_carta_de_otono.md`, y actualizados `CLAUDE.md` (montaje en Remotion, multitoma, búsqueda obligatoria de referencia) y `fuentes_plantillas_reels.md` (§4bis Instagram por palabra clave) |
...
| [`08-reel-chuleton-2026-09-15/`](08-reel-chuleton-2026-09-15/) | Aprendizajes, receta y evidencia del reel de chuletón (15/09) | Primer ensayo con la ruta Kling 3.0 / Seedance 2.5 |
| [`09-reel-volvemos-a-abrir-2026-09-17/`](09-reel-volvemos-a-abrir-2026-09-17/) *(nuevo, 2026-09-17)* | Registro completo del Reel 09, montado en **Remotion** en lugar de After Effects y con **multitoma de Seedance 2.5** (3 planos en un clip de 10 s); cálculo de cuánto abarata cada plan | Elimina la licencia de AE y el worker Windows del coste fijo, y reduce los segundos de vídeo complejo por reel |
